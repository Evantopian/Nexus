...
const FriendRequests = ({
  ...
  return (
    <div>
        ...
        <div className="mb-6">
          ...
          <div className="divide-y divide-gray-700/50">
            {received.map((req, index) => (
              <div
                key={index}
                className="p-4 hover:bg-gray-800/80 flex justify-between items-center transition-colors"
              >
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    onClick={() =>
                      acceptRequest({
                        variables: { senderId: req.sender.uuid },
                      })
                    }
                    title="Accept"
                  >
      ...
      {sent.length > 0 && (
        <div>
          <div className="p-3 bg-gray-100 dark:bg-gray-800/80 border-b border-gray-300 dark:border-gray-700 flex items-center text-black dark:text-white">
