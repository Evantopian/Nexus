...
// Tags with color mappings
export const gameTags: Record<string, GameTag> = {
    ...
    servers: [
      {
        ...
        members: 128,
        image: JeffLeShark,
        description: "We play Jeff the Land Shark on here...",
      },
      {
        id: 2,
        name: "Shield Academy",
        ...
        description: "For new players learning the ropes. Friendly...",
      },
      {
        id: 3,
